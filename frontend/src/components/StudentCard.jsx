                        ...
                        <div style={{ padding: '0 14px', marginTop: '3px', zIndex: 10 }}>
                            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '6.5px', fontFamily: '"Arial", sans-serif', color: '#0f172a', fontWeight: 700, lineHeight: '1.15' }}>
                                <tbody>
                                    ...
                                    <tr><td style={{ verticalAlign: 'top', paddingTop: '1px' }}>Alamat</td><td style={{ verticalAlign: 'top', paddingTop: '1px' }}>:</td><td style={{ lineHeight: '1.2', textTransform: 'uppercase', wordBreak: 'break-word', overflow: 'hidden', display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', maxHeight: '15px' }}>{(profile?.address || '').toUpperCase()}</td></tr>
                                </tbody>
                            </table>
                        </div>
