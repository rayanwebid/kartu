...
export default function Register() {
    const [form, setForm] = useState({
        ...
        nisn: '', nik: '', birth_place: '', birth_date: '', religion: 'Islam', address: ''
    });
        ...
        <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--surface-50)', padding: '2rem 1rem' }}>
            <div className="glass-card animate-fade-in" style={{ width: '100%', maxWidth: '600px', padding: '2rem' }}>
                <div style={{ textAlign: 'center', marginBottom: '1.5rem' }}>
                    ...
                    <p style={{ color: 'var(--text-500)', fontSize: '0.875rem' }}>Mohon isi data diri Anda dengan sebenar-benarnya untuk pendaftaran di <Link to="/" style={{ color: 'var(--primary-600)', fontWeight: 600, textDecoration: 'none' }}>{websiteName}</Link>.</p>
                </div>
